...
//
//     final apiGetWishList = apiGetWishListFromJson(jsonString);

import 'dart:convert';

List<ApiGetWishList> apiGetWishListFromJson(String str) => List<ApiGetWishList>.from(json.decode(str).map((x) => ApiGetWishList.fromJson(x)));

String apiGetWishListToJson(List<ApiGetWishList> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class ApiGetWishList {
    ...
    factory ApiGetWishList.fromJson(Map<String, dynamic> json) => ApiGetWishList(
        id: json["id"],
