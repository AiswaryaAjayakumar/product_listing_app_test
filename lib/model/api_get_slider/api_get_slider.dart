...
//
//     final apiGetSlider = apiGetSliderFromJson(jsonString);

import 'dart:convert';

List<ApiGetSlider> apiGetSliderFromJson(String str) => List<ApiGetSlider>.from(json.decode(str).map((x) => ApiGetSlider.fromJson(x)));

String apiGetSliderToJson(List<ApiGetSlider> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class ApiGetSlider {
    ...
    factory ApiGetSlider.fromJson(Map<String, dynamic> json) => ApiGetSlider(
        id: json["id"],
