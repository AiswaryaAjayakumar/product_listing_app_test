...
//
//     final apiGetProducts = apiGetProductsFromJson(jsonString);

import 'dart:convert';

List<ApiGetProducts> apiGetProductsFromJson(String str) => List<ApiGetProducts>.from(json.decode(str).map((x) => ApiGetProducts.fromJson(x)));

String apiGetProductsToJson(List<ApiGetProducts> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class ApiGetProducts {
    ...
    factory ApiGetProducts.fromJson(Map<String, dynamic> json) => ApiGetProducts(
        id: json["id"],
